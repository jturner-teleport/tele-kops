...
log ""
log "  (logins + kubernetes-groups make admin able to actually SSH and use kubectl;"
log "   the access role has wildcards on labels but reads users from these traits)"
log ""
